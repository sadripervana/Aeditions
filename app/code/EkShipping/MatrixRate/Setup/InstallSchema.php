...
namespace EkShipping\MatrixRate\Setup;
...
class InstallSchema implements InstallSchemaInterface
{
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        /**
         * Create table 'ekshipping_matrixrate'
         */
        $table = $installer->getConnection()->newTable(
            $installer->getTable('ekshipping_matrixrate')
        )->addColumn(
            'pk',
            ...
            $installer->getIdxName(
                'ekshipping_matrixrate',
                ['website_id', 'dest_country_id', 'dest_region_id', 'dest_city', 'dest_zip', 'condition_name',
                    'condition_from_value','condition_to_value','shipping_method','shipping_time'],
            ...
            'EkShipping Shipping MatrixRate'
        );
