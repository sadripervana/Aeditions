 ...
 */
namespace EkShipping\MatrixRate\Block\Adminhtml\Carrier\Matrixrate;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    /**
     * @var \EkShipping\MatrixRate\Model\ResourceModel\Carrier\Matrixrate\CollectionFactory
     */
     ...
     * @param \EkShipping\MatrixRate\Model\ResourceModel\Carrier\Matrixrate\CollectionFactory $collectionFactory
     * @param \EkShipping\MatrixRate\Model\Carrier\Matrixrate $matrixrate
     * @param array $data
     */
    public function __construct(
        \Magento\Backend\Block\Template\Context $context,
        \Magento\Backend\Helper\Data $backendHelper,
        \EkShipping\MatrixRate\Model\ResourceModel\Carrier\Matrixrate\CollectionFactory $collectionFactory,
        \EkShipping\MatrixRate\Model\Carrier\Matrixrate $matrixrate,
        array $data = []
    ) {
     ...
     *
     * @return \EkShipping\MatrixRate\Block\Adminhtml\Carrier\Matrixrate\Grid
     */
    protected function _prepareCollection()
    {
        /** @var $collection \EkShipping\MatrixRate\Model\ResourceModel\Carrier\Matrixrate\Collection */
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            'shipping_time',
            ['header' => __('Shipping Time'), 'index' => 'shipping_time']
        );
