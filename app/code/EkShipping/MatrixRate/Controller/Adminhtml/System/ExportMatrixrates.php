 ...
 */
namespace EkShipping\MatrixRate\Controller\Adminhtml\System;
...
class ExportMatrixrates extends \Magento\Config\Controller\Adminhtml\System\AbstractConfig
{
    ...
    {
        $fileName = 'ek_shipping.csv';
        /** @var $gridBlock \EkShipping\MatrixRate\Block\Adminhtml\Carrier\Matrixrate\Grid */
        $gridBlock = $this->_view->getLayout()->createBlock(
            'EkShipping\MatrixRate\Block\Adminhtml\Carrier\Matrixrate\Grid'
        );
