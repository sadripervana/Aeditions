...
namespace  Atniqi\ProductsWidgetSlider\Model\Plugin;
...
class Save extends \Magento\Widget\Controller\Adminhtml\Widget\Instance\Save
{
    ...
    public function aroundExecute($subject, $proceed)
    {
        ...
        if ($code == 'atniqi_products_widget_bestseller' || $code =='atniqi_products_widget_mostview') {
            $error = $this->atniqiBestSellerChecker();
            /*Return checker Validator*/
            return $this->checker($error, $proceed);
        }
        if ($code == 'atniqi_products_widget_onsale') {
            $error = $this->atniqiOnSaleChecker();
            /*Return checker Validator*/
            return $this->checker($error, $proceed);
        }
        return $proceed();
     ...
     * @return bool
     */
    public function atniqiOnSaleChecker()
    {
     ...
     * @return bool
     */
    public function atniqiBestSellerChecker()
    {
